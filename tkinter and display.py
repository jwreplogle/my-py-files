...
# tkinter entry
    ...
    tk.Label(master, text="Enter Text To Display on LED", fg='red').grid(row=0)
    tk.Label(master, text="Line 1").grid(row=1, column=0)
    tk.Label(master, text="Line 2").grid(row=2, column=0)
    tk.Label(master, text="Line 3").grid(row=3, column=0)
    tk.Label(master, text="Line 4").grid(row=4, column=0)
